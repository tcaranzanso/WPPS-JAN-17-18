angular.module("jkuri.datepicker", []).directive("ngDatepicker", ["$document", function (a) {
    var b = function (d, c) {
    ...
    return {restrict: "EA",
        ...
        link: function (g, e, d, j) {
            ...
            var c = moment();
            var f = function (l) {
                var k = l.endOf("month").date(), q = l.month(), p = l.year(), r = 1;
                ...
                for (var m = r; m <= k; m += 1) {
                    if (m > 0) {
                        g.days.push({day: m, month: q + 1, year: p, enabled: true})
                    } else {
                        g.days.push({day: null, month: null, year: null, enabled: false})
                    }
                }
            };
            var h = function () {
